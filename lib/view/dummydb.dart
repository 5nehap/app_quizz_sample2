class Dummydb {
  static List items = [
    ...
    {
      "images":
          "https://ali-cdn-wl-assets.classplus.co/production/single/gnels/8e393e18-5d55-441d-b0d7-8090f60edc06.jpg",
      "items": "General Knowledge",
    },
    {
      "images":
          "https://static1.squarespace.com/static/58ee0b551e5b6c8ff18b94ad/58ee41fa414fb5fa31858382/62fe887fb367333c1deca022/1716972818473/sports+quiz+questions+and+answers.jpg?format=1500w",
      "items": "sports",
    },
    {
       "images":"https://t4.ftcdn.net/jpg/04/66/44/45/240_F_466444523_VwJiDHD6ARJLCE7RXU2JqTsfKgV7HxH5.jpg",
    "items":"maths",
    },
    {
       "images":"https://t3.ftcdn.net/jpg/09/34/53/56/240_F_934535634_8PSN0uV5p0TcTwXiaf4uU3r94EplKkXn.jpg",
    "items":"informational technology",
    },
    {
       "images":"https://t3.ftcdn.net/jpg/01/66/70/32/240_F_166703275_YTHITBVnHD3tWS3q8RPvH0nFWmyrgAr5.jpg",
    "items":"science",
    },
  ];
  static List<Map> GeneralknowledgeList = [
    {
  ...
  static List<Map> ScienceList = [
    ...
    },
    {
      ...
      "options": ["Friction", "Magnetism", "Gravity", "Electromagnetism"],
      "answerindex": 2
    },
    {
    ...
    {
      "question": "What is the unit of measure for energy?",
  ...
  static List<Map> technologyList = [
    {
    ...
    },
    {
      ...
      "options": ["Store data", "Process data", "Send data", "Display data"],
      "answerindex": 1
    },
    {
    ...
    {
      "question":
          "What technology is used to make phone calls over the internet?",
      "options": ["VoIP", "DSL", "FTP", "LAN"],
      "answerindex": 0
    },
  ];
}
